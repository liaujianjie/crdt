 ...
 */
interface TwoPhaseSetPayload<Element extends CrdtAtom>
  extends StateBasedCrdtPayload {
  readonly added: GOSet<Element>;
  readonly removed: GOSet<Element>;
}

interface TwoPhaseSetQueryOps<Element extends CrdtAtom> {
  has(element: Element): boolean;
}

interface TwoPhaseSetUpdateOps<Element extends CrdtAtom> {
  /**
...
export class TwoPhaseSet<Element extends CrdtAtom>
  implements
